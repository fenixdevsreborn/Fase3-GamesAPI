...
/// <summary>Registers ActivitySource, FcgMeters, IObservabilityContextAccessor and OpenTelemetry. Then use app.UseFcgObservability().</summary>
public static class ObservabilityServiceCollectionExtensions
{
        ...
        Action<ObservabilityOptions>? configure = null)
    {
        ...
        services.AddTransient<ObservabilityDelegatingHandler>();
